...
namespace Footbet.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = CreateApplicationUserFromModel(model);
        ...
        public ActionResult Manage(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.ChangePasswordSuccess ? "Passordet ditt er blitt endret"
                : message == ManageMessageId.SetPasswordSuccess ? "Passordet ditt er blitt endret"
                : message == ManageMessageId.RemoveLoginSuccess ? "The external login was removed."
                : message == ManageMessageId.Error ? "En uventet feil har oppstått."
                : "";
